...
public class OrderPcbItemCacheDialog extends OrderPcbItemCacheDialogLayout implements CacheChangedListener<Order> {

    private final Application application;

    public OrderPcbItemCacheDialog(Application application, String title, ProjectPcb projectPcb) {
    ...
    private void selectOrder() {
        Order order;
        AddToOrderCacheDialog orderItemDialog = new AddToOrderCacheDialog(application, "Order", new ArrayList<>(), false, true);
