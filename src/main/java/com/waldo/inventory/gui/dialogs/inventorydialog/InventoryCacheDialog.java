...
public class InventoryCacheDialog extends InventoryCacheDialogLayout {


    public InventoryCacheDialog(Window window, String title, LocationType locationType) {
    ...
    public void onToolBarAdd(IdBToolBar source) {
        if (currentLocation != null) {
            AdvancedSearchDialog dialog = new AdvancedSearchDialog(InventoryCacheDialog.this, true);
    ...
    public void onToolBarEdit(IdBToolBar source) {
        if (currentItem != null) {
            EditItemDialog dialog = new EditItemDialog<>(InventoryCacheDialog.this, "Edit item", currentItem);
            dialog.showDialog();
