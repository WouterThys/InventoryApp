...
abstract class SelectPcbCacheDialogLayout extends ICacheDialog implements ItemListener{
     ...
     *                  CONSTRUCTOR
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    SelectPcbCacheDialogLayout(Window window, String title, ProjectPcb projectPcb) {
        super(window, title);
