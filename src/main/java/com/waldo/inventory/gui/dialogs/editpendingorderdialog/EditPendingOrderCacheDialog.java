...
public class EditPendingOrderCacheDialog extends EditPendingOrderCacheDialogLayout {


    public EditPendingOrderCacheDialog(Window window, String title, PendingOrder pendingOrder) {
    ...
    protected void onOK() {
        ...
        if (foundOrder != null && (pendingOrder.getId() > DbObject.UNKNOWN_ID || foundOrder.getId() != pendingOrder.getId())) {
            JOptionPane.showMessageDialog(
                    EditPendingOrderCacheDialog.this,
