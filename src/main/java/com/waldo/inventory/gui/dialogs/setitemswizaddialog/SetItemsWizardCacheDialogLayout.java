...
abstract class SetItemsWizardCacheDialogLayout extends ICacheDialog {
   ...
   *                  CONSTRUCTOR
   * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    SetItemsWizardCacheDialogLayout(Application application, String title, @NotNull Set set) {
