...
public class LinkPcbItemCacheDialog extends LinkPcbItemCacheDialogLayout {

    public LinkPcbItemCacheDialog(Application application, String title, ProjectPcb projectPcb) {
