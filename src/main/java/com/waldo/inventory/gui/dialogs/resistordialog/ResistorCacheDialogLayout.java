...
import com.waldo.inventory.gui.dialogs.resistorpreviewdialog.ResistorPreviewCacheDialog;
...
abstract class ResistorCacheDialogLayout extends ICacheDialog implements ItemListener {
   ...
   *                  CONSTRUCTOR
   * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ResistorCacheDialogLayout(Window window, String title, Resistor resistor) {
        super(window, title);
    ...
    public void initializeComponents() {
        ...
        testBtn.addActionListener(e -> {
            ResistorPreviewCacheDialog dialog = new ResistorPreviewCacheDialog(ResistorCacheDialogLayout.this, "Export", resistorImage.createPrintablePanel());
            dialog.showDialog();
        });
